...
?>
<div class="pull-left"><?php echo $comment->avatar; ?></div>
<?php
				}
?>
...
?>
<h4 class="media-heading"><?php echo $comment->author?> <small>says on <i class="fa fa-calendar"></i> <?php echo JCommentsText::formatDate($comment->date, JText::_('DATETIME_FORMAT')); ?></small></h4>
<?php
				}
?>
