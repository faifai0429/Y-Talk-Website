...
?>
	...
	<div class="comments-list media comment-item" id="comments-list-<?php echo $comment->parent; ?>">
<?php				
				} else {
					$j = 0;
...
?>
		<div class="<?php echo ($i%2 ? 'odd' : 'even'); ?> media comment-item" id="comment-item-<?php echo $id; ?>">
<?php
				echo $comment->html;
