...
?>
<div class="comment-avatar"><img src="images/no_avatar.png"></div>
<?php
				}
?>
...
?>
<small>says on <i class="fa fa-calendar"></i> <?php echo JCommentsText::formatDate($comment->date, JText::_('DATETIME_FORMAT')); ?></small>
<div id="comment-body-<?php echo $comment->id; ?>"><?php echo $comment->comment; ?></div>
<?php
