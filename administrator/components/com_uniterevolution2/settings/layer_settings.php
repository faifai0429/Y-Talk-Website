<?php
	...
	$layerSettings->addSection(__("Layer Params",REVSLIDER_TEXTDOMAIN),"layer_params");
	$layerSettings->addSap(__("Layer Params",REVSLIDER_TEXTDOMAIN),"layer_params");
	$layerSettings->addTextBox("layer_caption", "caption_green", __("Style",REVSLIDER_TEXTDOMAIN),array(UniteSettingsRev::PARAM_ADDTEXT=>$captionsAddonHtml,"class"=>"textbox-caption"));
